...
// function displayCarDetails(cardDetail) {
//     document.getElementById('car_show').src = cardDetail.image;
//     document.getElementById('company-title').innerHTML = `<h2>${cardDetail.name}..</h2>`;
//     document.getElementById('decription').innerText = `${cardDetail.descprition}`
//     document.getElementById('viedcars').href = `${cardDetail.link}`;
//     document.getElementById('readmore').href = `${cardDetail.about}`;
// }


            // const carDetail = {
            //     name = "",
            //     image: "../../assets/images/Ford_mus-gt.png",
            //     description: "",
            //     link: "",
            //     about: ""
            // }
            // displayCarDetails(carDetail);